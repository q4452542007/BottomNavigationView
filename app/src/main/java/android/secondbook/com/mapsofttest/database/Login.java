...
import android.secondbook.com.mapsofttest.MainActivity;
...
public class Login extends Activity {                 //登录界面活动
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /*mAccount.setInputType(InputType.TYPE_CLASS_TEXT |InputType.TYPE_TEXT_VARIATION_VISIBLE_PASSWORD);
        mAccount.setOnTouchListener(new View.OnTouchListener() {

            @Override
            public boolean onTouch(View arg0, MotionEvent arg1) {
                int inType = mAccount.getInputType(); // backup the input type
                mAccount.setInputType(InputType.TYPE_NULL); // disable soft input
                mAccount.onTouchEvent(arg1); // call native handler
                mAccount.setInputType(inType); // restore input type
                return true;
            }
        });*/
